...
namespace cAlgo.Robots
{
    ...
    public class MultiIndicatorScalper : Robot
    {
        ...
        protected override void OnStart()
        {
            ...
            Print("╔════════════════════════════════════════╗");
            Print("║      Multi-Indicator Scalper v4.1      ║");
            Print("║     Phase 3 Fixed — Optimizer Ready    ║");
            Print("╚════════════════════════════════════════╝");
            ...
            Print("✓ Bot v4.1 ready (bugs fixed)");
            Print("═════════════════════════════════════════");
        }
        ...
        protected override void OnBar()
        {
            ...
            // FIX: IsNewsTime() einmal pro Bar cachen
        ...
        private void UpdateHtfSupertrendIncremental()
        {
            ...
            // FIX: Warn wenn HTF-History erschöpft
            if (idx < 0 || idx >= HtfStHistory)
            {
                Print($"⚠ HTF Supertrend: idx {idx} out of range. Consider increasing HtfStHistory.");
                return;
            }
        ...
        private void ResetDailyTracking()
        {
            ...
            // FIX: Position-State nur zurücksetzen wenn keine offene Position existiert
        ...
        // FIX: isNewsNow als Parameter — kein doppelter IsNewsTime()-Aufruf
        ...
        private void CheckForEntrySignal()
        {
            ...
            // FIX: tautologische minScore-Variable entfernt
            if (longScore >= MinScoreToTrade)
            {
                ...
                // FIX: kein positionPatterns[0] Temp-Eintrag — direkt in ExecuteTrade gesetzt
                                  ...
                                  double riskMultiplier)
        {
            ...
            // FIX: GetEstimatedMargin mit korrektem tradeType
            ...
            // FIX: Pattern/Score direkt mit echter Position-ID speichern — kein Temp [0]
